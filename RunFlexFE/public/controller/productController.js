app.controller("ProductController", function($scope, $http, $window) {
    ...
    // Hàm khởi tạo filters
    $scope.initializeFilters = function() {
        $scope.filters = [{
                title: "Thương hiệu",
                items: $scope.brands,
                prefix: "brand",
                model: $scope.selectedBrands,
                isExpanded: false,
            },
            {
                title: "Danh mục",
                items: $scope.categorys,
                prefix: "category",
                model: $scope.selectedCategories, // Sửa model cho đúng
                isExpanded: false,
            },
            {
                title: "Đối tượng sử dụng",
                items: $scope.usageobjects,
                prefix: "usageobject",
                model: $scope.selectedUsageObjects,
                isExpanded: false,
            },
            {
                title: "Chất liệu",
